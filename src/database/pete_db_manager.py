    ...
    def __init__(self, db_path: str = None):
        ...
        if db_path is None:
            ...
            if env_path:
                ...
                # Find existing pete.db file (works locally and on RunPod)
                self.db_path = Path(self._find_pete_db())
        else:
            self.db_path = Path(db_path)
        
        self._connection = None
    
    def _find_pete_db(self) -> str:
        """Find existing pete.db file in common locations"""
        possible_paths = [
            # Current working directory (local development)
            ...
            os.path.join(os.path.expanduser("~"), "pete.db")
        ]
        ...
        # If no existing file found, default to current directory
